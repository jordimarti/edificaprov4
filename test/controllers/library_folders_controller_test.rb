...
class LibraryFoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library_folder" do
    assert_difference("LibraryFolder.count") do
      post library_folders_url, params: { library_folder: { account_id: @library_folder.account_id, name: @library_folder.name } }
    end
  ...
  test "should update library_folder" do
    patch library_folder_url(@library_folder), params: { library_folder: { account_id: @library_folder.account_id, name: @library_folder.name } }
