...
ActiveRecord::Schema.define(version: 2022_01_03_112549) do
  ...
  create_table "library_folders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_library_folders_on_account_id"
  end
  ...
  add_foreign_key "library_folders", "accounts"
